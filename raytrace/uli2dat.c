...
/*printf(" NormalDistorber: %f%%\n",d_rand());*/ 
   ...
   printf("MaxRecurse: %d\n", 5 + i_rand(5));
   printf("Backup: 200\n");
   printf("Observer: Vertex: (%1.12f,%1.12f,%1.12f)\n", 0., 0., -200.-150*d_rand());
   printf("LookZ: %f%%\n", 30.+20.*d_rand());	
   printf("Light: Vertex: (%1.12f,%1.12f,%1.12f)\n", 200.*d_rand()-100., 200.*d_rand()-100., -400.*d_rand());	
 ...
 for (i=0;i<n;i++)
   {
    printf("Triangle: %d\n",i+idx);
    printf("{\n");
    printf(" a: Vertex: (%1.12f,%1.12f,%1.12f)\n", t[i].a->x, t[i].a->y, t[i].a->z);
    printf(" b: Vertex: (%1.12f,%1.12f,%1.12f)\n", t[i].b->x, t[i].b->y, t[i].b->z);
    printf(" c: Vertex: (%1.12f,%1.12f,%1.12f)\n", t[i].c->x, t[i].c->y, t[i].c->z);
